...
describe("renderWebSite", () => {
  ...
  it("should render a head of 'site_0' site", () => {
    ...
    const expected = [
      ...
      '  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0&family=Material+Symbols+Rounded:opsz,wght,FILL,GRAD@24,200,1,0&family=Roboto&family=Noto+Sans+Japanese&family=Pathway+Extreme:ital,wght@0,400;0,800;1,400&display=swap">',
      '  <link rel="stylesheet" href="/css/tailwind.css">',
      '  <style>',
      '    [x-cloak] {',
      '      display: none !important;',
